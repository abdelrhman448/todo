...
class SizeConfig extends StatelessWidget {
  ...
  static double getHeight(double height,)=> MediaQuery.of(todoNavigatorKey.currentState!.context).size.height*(height/932);
  static double getWidth(double width,)=> MediaQuery.of(todoNavigatorKey.currentState!.context).size.width*(width/430);
